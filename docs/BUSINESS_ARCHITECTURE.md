...
| 구분 | 무료 (로컬 설치) | 베이직 (5만/월) | 프로 (10만/월) |
|------|:---:|:---:|:---:|
| **제공 형태** | 로컬 PC | 클라우드 (팜스퀘어) | 클라우드 (팜스퀘어) |
| **진입 방법** | GitHub 다운로드 + 팜스퀘어 무료가입(API 키) | 팜스퀘어 메뉴 | 팜스퀘어 메뉴 |
| **운영 시간** | PC 켜져있을 때 | 24시간 | 24시간 |
| | | | |
| **통합 검색** | O | O | O |
| **자동 주문** | O | O | O |
| **긴급주문 (재고감지 → 자동주문)** | O | O | O |
| **가격 변동 모니터링** | O | O | O |
| **MCP (Claude Desktop)** | O | O | O |
| | | | |
| **모니터링 간격** | 60분 | 30분 | 5분 |
| **알림 채널** | 텔레그램 | 텔레그램 + **카카오톡** | 텔레그램 + **카카오톡** |
| **검색 이력 보관** | 로컬 7일 | 클라우드 90일 | 클라우드 1년 |
| **도매상 수** | 8개 | 8개 | 8개 + 신규 우선 적용 |
| **다중 약국 관리** | 1개 | 1개 | **최대 3개** |
| **전용 대시보드** | 로컬 UI | 웹 대시보드 | 웹 대시보드 + 통계 |
| **기술 지원** | GitHub Issues | 이메일 | 카톡 채널 우선 응대 |
